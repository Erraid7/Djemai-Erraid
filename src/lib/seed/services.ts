...
export const services: Service[] = [
  {
    ...
    deliverables: [
      ...
      "A working API with authentication and role-based access",
  ...
  },
  {
    ...
    description:
      "For teams that already have a frontend (or a designer) but need a real backend behind it: schema design, authentication, permissions, background jobs, and an API built to hold up under real use -- not just pass a demo.",
    deliverables: [
      "Database schema design (PostgreSQL / Prisma)",
      "Authentication and role-based access control",
      "Background jobs and queues (Redis / BullMQ) when the work needs them",
      "An API tested before it ships -- Khatma's backend has 500+ automated tests",
    ],
    exampleProjectId: 2,
  ...
  {
    id: "mobile-first",
    title: "Mobile-First Web Apps & PWAs",
    tagline: "Built for the screen people actually use.",
    description:
      "Responsive, mobile-first web apps -- installable as PWAs when an app-like experience matters -- for products where most real usage happens on a phone, not a desktop demo.",
    deliverables: [
      "Mobile-first responsive design, not a desktop layout squeezed down",
      "Installable PWAs with an app-like experience",
